...
My age is ${10+10} `);
        ...
        //Sets == (add,clear,delete,has,size)
        var names = new Set();
        names.add("Amar").add("Akbar").add("Anthony");
        console.log("Names after add : ", names);
        console.log("Size of set : ", names.size);

        names.delete("Amar");
        console.log("Names after Delete : ", names);
        names.clear();
        console.log("Set after clear : ", names);


        var emp = ["a", "b", "c", "a", "b", "d"];
        var emp2 = new Set(emp);
        console.log(emp2);
        ...
        var myGen2 = gen2();
        console.log(myGen2.next(); myGen2.next(); myGen2.next(); myGen2.next();
        }